...
<div id="login-content">
    <div style="padding-top: 5%; width: 100%;">
        <!-- login form -->
        <form method="post" id="form-login"  action="actions.ezy/ezylogin.php">
            <div id="login-form" style="">
               ...
               <!-- <input placeholder='Identity Provider Server' list="email-data-list" class="login-field shadowed" type="text" name="login" id="input-email">
                ...
                <input placeholder='Password' class="login-field shadowed" style="margin-top: 10px;display: none" type="password" name="password" id="input-password" autocomplete="off" />
