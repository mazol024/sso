...
<!-- login-background -->
<div id="login-background" style=" background: url(/media/images/unleash-site.png) no-repeat, url(/media/images/unleash-kiwi.png) no-repeat, url('/media/images/unleash-logo.png') no-repeat, url(/media/images/unleash-background.png) no-repeat;background-size: auto 38.96%, 34.58% auto, auto 24.05%, 100% 100%; background-position: 96.52% 103.80%, 0% 80%, 101.12% 55%, 0px 400px;; width: 100%; height: calc(100% - 0px); position: absolute; bottom: 0px; z-index: -1;">
            ...
            <div id="login-form" style="">
                ...
                <div class="login-button" style="margin: 25px auto 0;">
                    <div id="div-login-button" class="login-button-content">
                        <!--Login-->
                        <input style="margin: 25px auto;text-align: center" type="submit" name="submit" id="submit" value="Login">
                    </div>
                    <div class="clear"></div>
                </div>
            </div><!-- /login form -->
