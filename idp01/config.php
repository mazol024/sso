...
$config = array(
     ...
     */
    'secretsalt' => 'newdefaultsecretsalt',
     ...
     *
     * It can be left unset, in which case, debugging is switched off for all actions.ezy.
     * If set, it MUST be an array containing the actions.ezy that you want to enable, or
     * alternatively a hashed array where the keys are the actions.ezy and their
     ...
     * actions.ezy here. Refer to the documentation of every module to learn if they
     * allow you to set any more debugging actions.ezy.
     *
     * The pre-defined actions.ezy are:
     *
     ...
     * app_login and logout requests, this option will control the maximum time these operations can take.
