...
$config = array(
    ...
    'default-sp' => array(
	 ...
	 'idp01-sp' => array(
        	...
        	'username' => 'simplesaml',
        	'password' => 'pwd',
        	'query' => 'SELECT uid, givenName, email, eduPersonPrincipalName FROM users WHERE uid = :username AND password = SHA(CONCAT((SELECT salt FROM users WHERE uid = :username), :password));',
	),
    /*
    'example-sql' => array(
        'sqlauth:SQL',
    ...
    */
    ...
    'example-userpass' => array(
        ...
        // Give the user an option to save their username for future app_login attempts
        ...
        'Bennett:pwd' => array(
            'uid' => array('ezyVet'),
            'eduPersonAffiliation' => array('member', 'Project Manager'),
        ),
        'bennett:pwd' => array(
            'uid' => array('ezyVet'),
            'eduPersonAffiliation' => array('member', 'Project Manager'),
